...
.cert-icon img {
    ...
    max-width: 100%;
    object-fit: contain;
    mix-blend-mode: multiply; /* Helps eliminate white backgrounds on JPGs */
}
...
@media (max-width: 1024px) {
    ...
    .cert-icon { height: 60px; width: 60px; padding: 6px; }
}
    ...
    <div class="e-con-inner cert-section-wrapper">
        ...
        <div class="cert-circles-container">
            <div class="cert-circle cert-solid">
                <div class="cert-icon">
                    <img src="/gallery/real_logo_1.jpg" alt="WHO Logo">
                </div>
            ...
            <div class="cert-circle cert-outline">
                <div class="cert-icon">
                    <img src="/gallery/real_logo_2.jpg" alt="ISO 9001 Logo">
                </div>
            ...
            <div class="cert-circle cert-solid">
                <div class="cert-icon">
                    <img src="/gallery/real_logo_3.jpg" alt="ISO 14001 Logo">
                </div>
            ...
            <div class="cert-circle cert-outline">
                <div class="cert-icon">
                    <img src="/gallery/real_logo_4.jpg" alt="ISO 45001 Logo">
                </div>
            ...
            <div class="cert-circle cert-solid">
                <div class="cert-icon">
                    <img src="/gallery/real_logo_5.jpg" alt="GLP Logo">
                </div>
...
console.log('Successfully applied real JPG logos.');
