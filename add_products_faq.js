...
// Find footer
let target = $('div[data-elementor-type="footer"]');
if (target.length) {
    target.first().before(productsFaqHtml);
} else {
    // If no explicit footer, just append to body (or the last main div)
    $('body').append(productsFaqHtml);
}
...
console.log("Added exact Visen FAQ section to Products page.");
